#include <Wire.h> //make pin A4, A5 sebagai SDA, SCL
...
//  Variables
int pulsePin = A2;                 // Pulse Sensor purple wire connected to analog pin
int blinkPin = 13;                // pin to blink led at each beat
int fadePin = 8;                  // pin to do fancy classy fading blink at each beat
int fadeRate = 0;                 // used to fade LED on with PWM on fadePin

const int pSuhu = A1;             //LM35
float suhu, data;                 //LM35
